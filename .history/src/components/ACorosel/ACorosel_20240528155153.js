...
import React from 'react';
import Skills from '../Skills/Skills';
import './ACorosel.css'; // Import the CSS file for ACorosel styles
import image from "../../assets/images/group_1_x2.svg"
...
const ACorosel = () => {
  ...
  return (
    <div className="acorosel-container">
      <div className="acorosel-title-container">
        <div className="acorosel-title-row">
          <div className="acorosel-logo">
            <img src="../../assets/images/group_1_x2.svg" alt="Image 1" />
          </div>
          <div className="acorosel-title">
            <span>K</span>
            <div className="title-oi">OI</div>
            <span>R</span>
            <div className="title-reader">EADER</div>
          </div>
        </div>
        <div className="acorosel-gradient"></div>
        <div className="acorosel-subtitle-row">
          <span>Innovate</span>
          <div className="acorosel-dot"></div>
          <span>Create</span>
          <div className="acorosel-dot"></div>
          <span>Automate</span>
        </div>
      </div>
      <div className="acorosel-content">
