...
import './CorosDisplay.css'; // Import the CSS file for CorosDisplay styles
...
const CorosDisplay = () => {
  ...
  return (
    <div id = ''className="relative flex flex-row box-sizing-border bg-gray-900 text-white">
      ...
      <div className="absolute top-0 right-0 mt-0 mr-2">
  <div className="w-[200px] h-[100px] bg-[50%_50%] bg-contain bg-no-repeat" style={{ backgroundImage: `url(${image12})`, backgroundSize: 'contain' }}></div>
</div>
