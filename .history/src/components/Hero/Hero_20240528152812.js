      ...
      <div className="hero-content">
        ...
        <div className="hero-text-container">
          <div className="hero-text">
            <span className="hero-text-line">The Logistics, Supply Chain,</span>
            <span className="hero-text-line">and Industrial Automation</span>
            <span className="hero-text-line">Platform</span>
          </div>
