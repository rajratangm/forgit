...
// import React from 'react';
// import './Location.css'; // Import the CSS file for Location styles
// import image75 from '../assets/images/image_58.png'; // Importing the image

// const Location = () => {
//   return (
//     <div className="bg-primary relative flex p-60-80-42-88 w-full">
//       <div className="relative flex flex-row justify-between w-1256.5 h-fit-content">
//         {/* Image and text container */}
//         <div className="m-0 flex flex-row box-sizing-border">
//           <div className="bg-[50%_50%] bg-contain bg-no-repeat w-[110px] h-[110px]">
//             <img src={image75} alt="Location" className="w-full h-full" />
//           </div>
//           <div className="m-[39.7px_0_41.3px_0] inline-block break-words font-['Inter'] font-normal text-[23.8px] leading-[1.21] uppercase text-[#FFFFFF]">
//             Locations
//           </div>
...
//       </div>
//       {/* Blue line */}
//       <div className="bg-primary absolute right-134.5 bottom-110 w-949.1 h-1"></div>
//       {/* USA and India info */}
//       <div className="absolute right-150.7 bottom-42.5 flex flex-row justify-between w-989.1">
//         {/* USA */}
//         <div className="flex flex-col items-center">
//           <div className="m-0 inline-block break-words font-['Inter'] font-semibold text-[19.4px] leading-[1.546] uppercase text-[#2FAFBF]">USA</div>
//           <div className="rounded-[50px] bg-[#2FAFBF] m-0 w-[12px] h-[12px]"></div>
//           <div className="flex flex-col items-center box-sizing-border">
//             <span className="m-0 break-words font-['Inter'] font-light text-[17px] leading-[1.588] text-[rgba(255,255,255,0.92)]">
//               1234 Street Name
//             </span>
//             <span className="m-0 break-words font-['Inter'] font-light text-[17px] leading-[1.588] text-[rgba(255,255,255,0.92)]">
//               City, State ZIP
...
//         {/* India */}
//         <div className="flex flex-col items-center">
//           <div className="m-0 inline-block break-words font-['Inter'] font-semibold text-[19.4px] leading-[1.546] uppercase text-[#2FAFBF]">India</div>
//           <div className="rounded-[50px] bg-[#2FAFBF] m-0 w-[12px] h-[12px]"></div>
//           <div className="flex flex-col items-center box-sizing-border">
//             <span className="m-0 break-words font-['Inter'] font-light text-[17px] leading-[1.588] text-[rgba(255,255,255,0.92)]">
//               #154/20, 5th Main, HSR Layout 7th Sector
...
//         </div>
//       </div>
//       {/* Dark gray and light gray bars */}
//       <div className="bg-secondary absolute left-0 top-0 right-0 h-160"></div>
//       <div className="bg-tertiary absolute left-0 top--1 right-0 h-120"></div>
//     </div>
//   );
// }
