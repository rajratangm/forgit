...
import React from 'react';
import image from '../../assets/images/logo.svg'; // Adjust the path to your logo
...
const Navbar = () => {
  return (
    <div className="shadow-[1px_1px_5px_0px_rgba(0,0,0,0.25)] bg-[#FFFFFF] flex flex-row justify-between p-[5.5px_90.4px_5.5px_95.6px] w-full box-sizing-border">
      ...
      <div className="m-[6px_0_7px_0] flex flex-row space-x-6 h-[fit-content] box-sizing-border ml-70">
        <a href="#footer" className="break-words font-['Inter'] font-medium text-[17.9px] leading-[1.508] uppercase text-[#535050]">
          Solutions
        </a>
        <a href="#integrations" className="break-words font-['Inter'] font-medium text-[17.9px] leading-[1.508] uppercase text-[#535050]">
          Integrations
