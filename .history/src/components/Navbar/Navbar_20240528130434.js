...
//         <img src="logo.png" alt="Logo" className="h-[fit-content]" />
//       </div>
...
const Header = () => {
  return (
    <div className="shadow-[1px_1px_5px_0px_rgba(0,0,0,0.25)] bg-[#FFFFFF] flex flex-row justify-between p-[5.5px_90.4px_5.5px_95.6px] w-[1425px] box-sizing-border">
      <div className="flex flex-row box-sizing-border">
        <div className="m-[0_7px_0_0] flex w-[25.9px] h-[40px] box-sizing-border">
          <img src="your_image_source_here" className="w-[25.9px] h-[40px]" alt="Your alt text here" />
        </div>
        <div className="relative m-[1.5px_0_2.5px_0] flex box-sizing-border">
          <div className="relative flex flex-row box-sizing-border">
            <span className="m-[0_21.3px_0_0] break-words font-['Inter'] font-light text-[24.9px] leading-[1.446] text-[#535050]">
      ...
      <div className="m-[6px_0_7px_0] flex flex-row justify-between w-[860.9px] h-[fit-content] box-sizing-border">
        <span className="m-[0_13.5px_0_0] w-[154.5px] break-words font-['Inter'] font-medium text-[17.9px] leading-[1.508] uppercase text-[#535050]">
          Solutions
        </span>
        <span className="break-words font-['Inter'] font-medium text-[17.9px] leading-[1.508] uppercase text-[#535050]">
          Integrations
        </span>
        <span className="break-words font-['Inter'] font-medium text-[17.9px] leading-[1.508] uppercase text-[#535050]">
          Awards
