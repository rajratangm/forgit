...
const Navbar = () => {
  return (
    <div className="shadow-[1px_1px_5px_0px_rgba(0,0,0,0.25)] bg-[#FFFFFF] flex justify-between items-center px-[5.5px_90.4px_5.5px_95.6px] w-full box-sizing-border">
      {/* Logo KOIREADER */}
      <div className="flex items-center">
        ...
        <div className="flex flex-row">
          ...
          <span className="break-words font-['Inter'] font-light text-[24.9px] leading-[1.446] text-[#535050] ml-1">R</span>
