...
function Navbar() {
  return (
    <div className="navbar flex flex-row justify-between items-center w-[860.9px] h-[fit-content] px-6 py-4">
      {/* Logo and Company Name */}
      <div className="flex items-center">
        <img src="logo.png" alt="Company Logo" className="w-12 h-12 mr-2" />
...
function NavLink({ text }) {
  return (
    <span className="nav-link mr-4 text-sm text-gray-600 uppercase">{text}</span>
  );
}
