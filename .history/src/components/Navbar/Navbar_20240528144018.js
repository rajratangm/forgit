      ...
      <div className="navbar-container">
        <div className="logo-container">
          ...
          <div className="logo-text">
            <span className="logo-text-initial">K</span>
            <span className="logo-text-initial">R</span>
            <div className="logo-text-main">EADER</div>
            <span className="logo-text-sub">OI</span>
          </div>
        </div>
        <div className="menu-container">
          <span className="menu-item">Solutions</span>
          <span className="menu-item">Integrations</span>
          <span className="menu-item">Awards</span>
