...
const Header = () => {
  return (
    <div className="divcss-oakiva">
      <div className="divcss-759-u-601">
        <div className="image-33">
          <img className="group-5" src="assets/vectors/Group6_x2.svg" alt="Logo" />
        </div>
        <div className="paragraphchakra-text-4">
          <div className="container-6">
            <span className="k-1">K</span>
            <span className="r-1">R</span>
            <div className="header-1">HEADER</div>
          </div>
          <span className="oi-1">OI</span>
        </div>
      </div>
      <div className="listcss-hnf-0-u-8">
